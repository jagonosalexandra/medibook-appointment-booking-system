...
const TimeSlots = () => {
    ...
    return (
        <div className='w-full h-screen px-4 lg:px-12 py-8 overflow-y-auto bg-gray-50/30 pb-20'>

            <div className='mb-6'>
                <h1 className='text-3xl lg:text-4xl font-black'>Time Slot Management</h1>
                        ...
                        <div className='flex px-1 w-fit'>
                            {TABS.map(tab => (
                                <button
                                    ...
                                    className={`px-5 py-2 text-sm font-semibold transition-all border-b border-gray-400
                                            ${activeTab === tab
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                <div className='flex flex-col sm:flex-row sm:items-center justify-between bg-white border border-gray-200 rounded-xl px-4 lg:px-6 py-3 shadow-sm gap-3'>
                                    <div className='flex items-center gap-2 lg:gap-4'>
                                        <button
                                            onClick={goToToday}
                                            className='px-3 lg:px-4 py-1.5 border border-gray-300 rounded-md text-sm font-semibold hover:bg-gray-50 transition-all'
                                        >
                                            Today
                                        </button>
                                ...
                                {loadingSlots ? (
                                    <LoadingSpinner message='Fetching schedule...' />
                                ) : (
                                    <div className='overflow-x-auto rounded-2xl shadow-lg border border-gray-200'>
                                        <div className='bg-white'>
                                            {/* Calendar Header */}
                                            <div className='grid grid-cols-[125px_repeat(7,1fr)] bg-gray-50 border-b border-gray-200 sticky top-0 z-10'>
                                                <div className='p-4 border-r border-gray-200 hidden md:flex items-center justify-center bg-gray-100/50'>
                                                    <img src={clock} className='w-4 opacity-40 hidden md:block' alt='' />
                                                </div>
                                                {weekDates.map((dateStr, idx) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={dateStr}
                                                            className={`p-3 text-center border-r last:border-r-0 border-gray-200 ${isToday ? 'bg-primary/5' : ''}`}
                                                        >
                                            ...
                                            <div>
                                                {TIME_OPTIONS.map((time) => (
                                                    <div
                                                        key={time}
                                                        className='grid grid-cols-[125px_repeat(7,1fr)] border-b border-gray-100 last:border-b-0 group'
                                                    >
                                                        <div className='p-4 hidden md:flex items-center justify-center border-r border-gray-200 bg-gray-50/30 group-hover:bg-gray-100 transition-colors'>
                                                        ...
                                                        {weekDates.map(dateStr => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={dateStr}
                                                                    className='p-1 border-r last:border-r-0 border-gray-100 min-h-21.25 bg-white group-hover:bg-gray-50/20 transition-all'
                                                                >
                                                                    {slot ? (
                                                                        <button
                                                                        ...
                                                                        >
                                                                            <div className='flex justify-between items-start w-full'>
                                                                                <span className={`text-[10px] font-black tracking-tight ${slot.isAvailable ? 'text-success' : 'text-red-700'}`}>
